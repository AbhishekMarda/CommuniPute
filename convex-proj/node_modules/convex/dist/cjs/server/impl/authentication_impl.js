...
__export(authentication_impl_exports, {
  setupActionAuth: () => setupActionAuth,
  setupAuth: () => setupAuth
});
...
function setupAuth() {
  return {
    getUserIdentity: () => {
      const syscallJSON = (0, import_syscall.performSyscall)("getUserIdentity", {});
      return Promise.resolve(syscallJSON);
    }
  };
}
function setupActionAuth(requestId) {
  return {
    getUserIdentity: () => {
      const syscallJSON = (0, import_syscall.performSyscall)("actions/getUserIdentity", {
        requestId
      });
      return Promise.resolve(syscallJSON);
    }
