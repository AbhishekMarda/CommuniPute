 ...
 */
export declare type Expand<ObjectType extends Record<any, any>> = ObjectType extends Record<any, any> ? {
 ...
 */
export declare type BetterOmit<T, K extends keyof T> = {
    [Property in keyof T as Property extends K ? never : Property]: T[Property];
};
/**
 * From ObjectType, pick the properties that are assignable to T.
 */
export declare type PickByValue<ObjectType, T> = Pick<ObjectType, {
 ...
 * `A & B & C`.
 */
export declare type UnionToIntersection<UnionType> = (UnionType extends any ? (k: UnionType) => void : never) extends (k: infer I) => void ? I : never;
