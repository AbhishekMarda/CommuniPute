...
export const convexImport = new Command("import").description("Import data from a file into a Convex table").addOption(
  new Option(
    "--format <format>",
...
).addOption(new Option("--url <url>").hideHelp()).addOption(new Option("--admin-key <adminKey>").hideHelp()).argument("<tableName>", "Destination table name").argument("<path>", "Path to the input file").action(async (tableName, path, options) => {
