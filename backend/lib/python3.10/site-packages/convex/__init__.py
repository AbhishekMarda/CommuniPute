...
class ConvexClient:
    ...
    def query(self, name: str, *args: CoercibleToConvexValue) -> ConvexValue:
        url = f"{self.address}/api/query"
        return self._request(url, name, args)

    def mutation(self, name: str, *args: CoercibleToConvexValue) -> ConvexValue:
        url = f"{self.address}/api/mutation"
        return self._request(url, name, args)

    def action(self, name: str, *args: CoercibleToConvexValue) -> ConvexValue:
